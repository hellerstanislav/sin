...
shlukováním zvířat či hmyzu (například hejna ptáků, ryb, apod.). Poprvé byla představena roku 1995 a od té doby
...
podle rovnic:
\begin{eqnarray}
v_i & \leftarrow & v+\varphi_1\otimes(p_i-x_i)+\varphi_2\otimes(p_g-x_i), \label{eqn:pso1} \\
...
částice $v_1$ je určována třemi jednotlivými částmi -- "hybností", "poznávací" částí a částí "sociální".
Hybnost $v_i$ reprezentuje předchozí rychlost částice, která\dots

Pozice $p_g$ sociální části je\dots
...
{\it biomedical image registration},
či komponování hudby. V posledních letech byly metody PSO (jejich varianty) oblíbené také ve víceúčelové
a dynamické optimalizaci.
%TODO metody cesky (jak prelozit? co jsou zac?) http://ieeexplore.ieee.org/stamp/stamp.jsp?arnumber=00898095

...
jakými dokáže hmyz řešit problémy, které jsou nad síly jedinece a přesností
...
kooperativní transport v~oblasti robotiky či problémy, ve kterých je třeba systémy
s~vysokou adaptabilitou a schopností samoopravy.
...
\begin{define}
  ...
  než by je řešil jednotlivec. \cite[s.1]{Heylighen99}
\end{define}
...
takový hmyz vykazuje při řešení základních problémů poměrně vysokou inteligenci. V této
kapitole se budeme věnovat popisu některých jevů, se kterými se ve spojitosti s~chováním
společenského hmyzu můžeme setkat. Tento popis bude uveden v míře nezbytné pro pochopení
problematiky, avšak se zřetelem na technické, nikoli biologické zaměření tohoto učebního
textu.
...
simulátorů robotickýc systémů, ale pro modelování swarmu je třeba zajistit větší důraz na
...
než senzorově orientované modely a přitom postkytují dostatečně přesné parametry chování
a výstupy systému.

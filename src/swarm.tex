...
těchto problému bylo zobecněno například na {\it problém obchodního cestujícího} (TSP),
...
({\it multimodální optimalizace}), či optimalizací {\it dynamickou} \cite{Blum08SwarmOpt}.
...
shlukováním zvířat či hmyzu (například hejny ptáků nebo ryb). PSO optimalizuje problém\dots
...
\begin{description}
\item[Optimalizace včelím rojem (BCO)] je\dots 
\item[Optimalizace hejnem světlušek (GSO)] je\dots
\item[Stochastic diffusion search (SDS)] je\dots
\end{description}

...
shlukováním zvířat či hmyzu (například hejna ptáků, ryb, apod.). Poprvé byla představena roku 1995 jako metoda
pro spojitou optimalizaci a od té doby
...
Průběh základní verze PSO ukazuje algoritmus \ref{alg:pso}.
...
\begin{figure}[here]
  ...
  \caption{Části PSO jako vektory (TODO překreslit).}
  \label{fig:psovec}
\end{figure}

\subsubsection{Varianty}
Topologie sousedů, inerciální váha a velocity clamping\dots

\medskip

Existuje mnoho dalších variant PSO, např. rozšíření o využití nad binárními prohledávacími prostory, možnost diskrétní či kombinované optimalizace, adaptivní verze algoritmů, víceúčelová optimalizace, aj.
